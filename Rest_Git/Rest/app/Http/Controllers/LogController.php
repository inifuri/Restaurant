...
use rest\Http\Requests\LoginRequest;
use Auth;
use Session;
use Redirect;
...
class LogController extends Controller
{
    ...
    public function store(LoginRequest $request)
    {
        ...
        if(Auth::attempt(['username'=> $request['username'], 'password'=> $request['password'], 'categoria'=>'Garzón'])){
            return Redirect::to('garzon');
        }
        else{
        Session::flash('message-error', 'Datos incorrectos');
        return Redirect::to('/')->withErrors(['Credenciales erróneas']);
        }
    }
